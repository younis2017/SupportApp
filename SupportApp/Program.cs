...
public partial class Program {
    private static void Main (string[] args)
        ...
        //        };
        //});
        // MVC with views and Razor Pages
        builder.Services.AddControllersWithViews();
        // Add HttpClient factory
        builder.Services.AddHttpClient("SupportApp", client =>
        {
            client.BaseAddress = new Uri("https://localhost:7024/"); // Your API base URL
        });
        ...
        builder.Services.AddOpenTelemetry()
            .WithTracing(tracerProviderBuilder =>
            {
                tracerProviderBuilder
                    .SetResourceBuilder(
                        ResourceBuilder.CreateDefault().AddService("SupportApp")
                    )
        ...
        app.MapRazorPages(); //  this is required for Razor Pages
        // Map SignalR hub
